    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('strip_menu', models.CharField(blank=True, max_length=200, null=True)),
                ('mega_menu', models.TextField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='images', to='main.product')),
            ],
        ),
        migrations.CreateModel(
            name='Customer',
